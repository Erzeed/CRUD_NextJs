export default function ModalForm() {
  return (
    <div
      ...
      //   tabIndex="-1"
      aria-hidden="true"
      className="hidden fixed inset-0 z-50 h-full w-screen flex justify-center items-center bg-black bg-opacity-50 backdrop-filter backdrop-blur-sm"
    >
      <div className="p-2 w-full max-w-md max-h-full overflow-y-auto">
        <div className="bg-black rounded-lg border-4 border-gray-800">
          ...
          <form className="p-4 md:p-5">
            <div className="grid gap-4 mb-4 grid-cols-2">
              ...
              <button
                className="bg-green-200 px-2 rounded-full text-sm text-lime-800 font-medium"
                type="button"
              >
                tambahkan supplier
              </button>
              ...
              <div className="col-span-2">
                <textarea
                  id="description"
                  rows="4"
                  className="block p-2.5 w-full text-sm text-gray-900 bg-[#1F2937] rounded-lg focus:ring-blue-500 focus:border-blue-500"
